...
# for import update product---------
from app.models.product_model import Product, ProductUpdate
# import complete CRUD operation   ------------------------
...
# 1------ comment because we do not want to start consumer & Table   ----------------------
    # task = asyncio.create_task(consume_messages(
    #     settings.KAFKA_PRODUCT_TOPIC, 'broker:19092'))
    create_db_and_tables()
    yield

# 2---hello world run   in docker compose  ( docker compose up --build )
app = FastAPI(
    lifespan=lifespan,
...
# get route get all product by ID for code cleaning & code organization ==================================================
@app.get("/manage-products/all", response_model=list[Product])
# function = call_all_products   and all dependencies----------------- 
